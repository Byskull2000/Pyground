...
export default function AdminUnidadDetailPage() {
    ...
    const fetchUnidad = useCallback(async () => {
        try {
            ...
            // Obtener datos de la unidad plantilla (admin)
            const response = await fetch(`${API_URL}/api/unidades-plantilla/${unidadId}`, {
                ...
                <div className="bg-gradient-to-br from-purple-600/20 via-indigo-600/20 to-pink-600/20 backdrop-blur-xl rounded-2xl p-6 border border-white/10 mb-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium bg-blue-500/20 text-blue-300 border border-blue-500/30">
